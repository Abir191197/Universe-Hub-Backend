...
function sendPaymentRequest(paymentData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const payload = {
            ...
            success_url: `https://universe-hub-backend.onrender.com/api/payment/confirmation?bookingId=${paymentData.id}&status=success`,
            fail_url: `https://universe-hub-backend.onrender.com/api/payment/confirmation?bookingId=${paymentData.id}&status=failed`,
            cancel_url: "/",
